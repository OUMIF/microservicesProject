...
@Component({
  selector: 'app-gestion-test-prof',
  imports: [CommonModule , SidebarProfComponent],
  templateUrl: './gestion-test-prof.component.html',
  styleUrl: './gestion-test-prof.component.css'
})
export class GestionTestProfComponent {
