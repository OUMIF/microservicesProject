...
export class CreateFormationProfComponent {
  ...
  studentsByFiliere: { [key: string]: any[] } = {
    ...
    'GSTR': [
      { id: '4', name: 'Youssef Tazi', email: 'youssef@example.com', filiere: 'GSTR' },
      { id: '5', name: 'Laila Benali', email: 'laila@example.com', filiere: 'GSTR' }
    ],
    'G3EI': [
      { id: '6', name: 'Karim El Fassi', email: 'karim@example.com', filiere: 'G3EI' }
    ],
    'GSEA': [
      { id: '7', name: 'Nadia Chakir', email: 'nadia@example.com', filiere: 'GSEA' }
    ],
    'GIND': [
      { id: '8', name: 'Omar Bennani', email: 'omar@example.com', filiere: 'GIND' }
    ]
  };
