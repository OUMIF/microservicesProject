        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LieuDeNaissance = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    AnneeDEtude = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Filiere = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Matricule = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    YearsOfExperience = table.Column<int>(type: "int", nullable: true),
                    ModulesEnseignes = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ProfessorFilieres = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { "1", null, "Admin", "ADMIN" },
                    { "2", null, "Professeur", "PROFESSEUR" },
                    { "3", null, "Etudiant", "ETUDIANT" }
                });
